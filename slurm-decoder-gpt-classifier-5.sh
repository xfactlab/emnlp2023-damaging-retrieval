...
--run_name sequential-decoder-classifier-batch16X8-lr6e-4-n_layer12-combdata-block_size100 \
--output_dir /scratch/philhoon-relevance/decoder-classification/results/NQ-DEV-DPR/5-fold/1/sequential-decoder-classifier-batch16X8-lr6e-4-n_layer12-combdata-block_size100 \
...
# sbatch --gpus 1 --cpus-per-gpu=8 slurm-decoder-gpt-classifier-5.sh
