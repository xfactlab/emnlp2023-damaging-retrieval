...
CUDA_VISIBLE_DEVICES="$gpu_" python binary_classifier_encoder_predict.py \
--do_train False \
--do_eval True \
--do_predict True \
--per_device_eval_batch_size 256 \
--config_base_path /data/philhoon-relevance/FiD/pretrained_models/nq_reader_large \
--prediction_model_name_or_path /data/philhoon-relevance/binary-classification/results/NQ-DEV-DPR/5-fold/1/fid-encoder-adpative-decisive-trial7 \
--prediction_model_step 660 \
--max_seq_length 200 \
--intact_eval False \
...
#CUDA_VISIBLE_DEVICES=1 python binary_classifier_encoder_predict.py \
#--do_train False \
#--do_eval True \
#--do_predict True \
#--per_device_eval_batch_size 256 \
...
#--config_base_path /data/philhoon-relevance/FiD/pretrained_models/nq_reader_large \
#--prediction_model_name_or_path /data/philhoon-relevance/binary-classification/results/NQ-DEV-DPR/5-fold/1/fid-encoder-adpative-decisive-trial7 \
#--prediction_model_step 360 \
#--max_seq_length 200 \
#--intact_eval False \
#--eval_file /data/philhoon-relevance/binary-classification/NQ-TEST-DPR/binary_decisive_format_ctx100id_test.json \
#--dataset_class BinaryCustomDatasetShuffle \
#--num_labels 2 \
#--headtype adaptive
...
# intact_eval False
#CUDA_VISIBLE_DEVICES=0 python binary_classifier_encoder_predict.py \
#--do_train False \
#--do_eval True \
#--do_predict True \
#--per_device_eval_batch_size 256 \
#--config_base_path /data/philhoon-relevance/FiD/pretrained_models/nq_reader_large \
#--prediction_model_name_or_path /data/philhoon-relevance/binary-classification/results/NQ-DEV-DPR/5-fold/1/fid-encoder-linear-decisive-trial6 \
#--prediction_model_step 80 \
#--max_seq_length 200 \
#--intact_eval False \
#--eval_file /data/philhoon-relevance/binary-classification/NQ-TEST-DPR/binary_decisive_format_ctx100id_test.json \
#--dataset_class BinaryCustomDatasetShuffle \
