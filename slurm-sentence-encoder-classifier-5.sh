...
--run_name FiD-Encoder-lstm-12layers-sequence_exclude_no_answer_partial_decisive \
--output_dir /data/philhoon-relevance/binary-classification/results/NQ-DEV-DPR/5-fold/1/FiD-Encoder-lstm-12layers-sequence_exclude_no_answer_partial_decisive \
--seed 42 \
--num_layers 12 \
--drop_out_rate 0.2 \
--padding -100 \
...
--train_file /data/philhoon-relevance/binary-classification/NQ-DEV-DPR/5-fold/1/sequence_exclude_no_answer_partial_decisive/sequence_exclude_no_answer_partial_decisive_ctx100id_split_train_1.pickle \
--eval_file /data/philhoon-relevance/binary-classification/NQ-DEV-DPR/5-fold/1/sequence_exclude_no_answer_partial_decisive/sequence_exclude_no_answer_partial_decisive_ctx100id_split_dev_1.pickle \
