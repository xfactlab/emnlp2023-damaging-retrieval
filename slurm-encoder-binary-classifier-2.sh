...
--report_to wandb \
--wandb_project binary_classifier \
--run_name fid-encoder-adpative-decisive-trial7 \
--output_dir /data/philhoon-relevance/binary-classification/results/NQ-DEV-DPR/5-fold/1/fid-encoder-adpative-decisive-trial7 \
--per_device_train_batch_size 64 \
--per_device_eval_batch_size 128 \
--seed 42 \
--learning_rate 5e-5 \
