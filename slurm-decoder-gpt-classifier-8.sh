...
--run_name sequential-decoder-classifier-batch64X2-lr6e-5-n_layer12-combdata-block_size40 \
--output_dir /scratch/philhoon-relevance/decoder-classification/results/NQ-DEV-DPR/5-fold/1/sequential-decoder-classifier-batch64X2-lr6e-5-n_layer12-combdata-block_size40 \
