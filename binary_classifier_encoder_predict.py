...
def eval(model_args, data_args, train_args):
    ...
    config = AutoConfig.from_pretrained(model_args.config_base_path, num_labels=data_args.num_labels)
    tokenizer = AutoTokenizer.from_pretrained('t5-base')

    # Get model architecture from FiDT5
    fid_model = FiDT5.from_pretrained(model_args.config_base_path)
