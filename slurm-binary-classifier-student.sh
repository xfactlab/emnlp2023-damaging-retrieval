...
#--report_to wandb \
#--wandb_project binary_classifier \
#--run_name roberta-decisive_binary_data_trial6 \
#--output_dir /data/philhoon-relevance/binary-classification/results/NQ-DEV-DPR/5-fold/1/roberta-decisive_binary_data_trial6 \
#--per_device_train_batch_size 80 \
#--per_device_eval_batch_size 128 \
#--seed 42 \
#--learning_rate 5e-5 \
...
#--report_to wandb \
#--wandb_project binary_classifier \
#--run_name studnet-roberta-binary-data-trial1 \
#--output_dir /data/philhoon-relevance/binary-classification/results/NQ-DEV-DPR/5-fold/1/roberta-decisive_binary_gold_data_trial1/step_320/dev_prediction/5-fold/1/studnet-roberta-binary-data-trial1 \
...
#--model_name_or_path roberta-large \
#--max_seq_length 200 \
#--data NQ-DEV-DPR/5-fold/1/teacher-prediction/5-fold/1 \
#--train_file /data/philhoon-relevance/binary-classification/results/NQ-DEV-DPR/5-fold/1/roberta-decisive_binary_gold_data_trial1/step_320/dev_prediction/5-fold/1/prediction_split_train_1.json \
#--eval_file /data/philhoon-relevance/binary-classification/results/NQ-DEV-DPR/5-fold/1/roberta-decisive_binary_gold_data_trial1/step_320/dev_prediction/5-fold/1/prediction_split_dev_1.json \
...
--report_to wandb \
--wandb_project binary_classifier \
--run_name studnet-roberta-binary-data-trial9 \
--output_dir /data/philhoon-relevance/binary-classification/results/NQ-DEV-DPR/5-fold/1/roberta-decisive_binary_gold_data_trial1/step_320/dev_prediction/5-fold/1/studnet-roberta-binary-data-trial9 \
--per_device_train_batch_size 32 \
--per_device_eval_batch_size 48 \
--seed 42 \
--learning_rate 5e-4 \
...
--train_file /data/philhoon-relevance/binary-classification/results/NQ-DEV-DPR/5-fold/1/roberta-decisive_binary_gold_data_trial1/step_320/dev_prediction/5-fold/1/prediction_split_train_1.json \
--eval_file /data/philhoon-relevance/binary-classification/results/NQ-DEV-DPR/5-fold/1/roberta-decisive_binary_gold_data_trial1/step_320/dev_prediction/5-fold/1/prediction_split_dev_1.json \
--dataset_class BinaryCustomDatasetPredictionShuffle \
--num_labels 2
