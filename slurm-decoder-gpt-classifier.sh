...
--run_name TEST \
--output_dir /scratch/philhoon-relevance/decoder-classification/results/NQ-DEV-DPR/5-fold/1/TEST \
...
# sbatch --gpus 1 --cpus-per-gpu=8 slurm-decoder-gpt-classifier.sh
