...
--run_name sentencebert-lstm-12layers-sequence_include_no_answer_include_indecisve_trial \
--output_dir /data/philhoon-relevance/binary-classification/results/NQ-DEV-DPR/5-fold/1/sentencebert-lstm-12layers-sequence_include_no_answer_include_indecisve_trial \
--seed 42 \
--num_layers 12 \
--drop_out_rate 0.2 \
--padding -100 \
...
--train_file /data/philhoon-relevance/binary-classification/NQ-DEV-DPR/5-fold/1/ctx100id_split_train_1.json \
--eval_file /data/philhoon-relevance/binary-classification/NQ-DEV-DPR/5-fold/1/ctx100id_split_dev_1.json \
