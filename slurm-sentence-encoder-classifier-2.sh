...
--run_name FiD-Encoder-lstm-12layers-sequence_exclude_no_answer_exclude_indecisve \
--output_dir /data/philhoon-relevance/binary-classification/results/NQ-DEV-DPR/5-fold/1/FiD-Encoder-lstm-12layers-sequence_exclude_no_answer_exclude_indecisve \
--seed 42 \
--num_layers 12 \
--drop_out_rate 0.2 \
--padding -100 \
