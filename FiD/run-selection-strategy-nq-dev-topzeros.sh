...
for file in /data/philhoon-relevance/FiD/open_domain_data/NQ_DPR_DEV_SELECTION_METHOD3/*/*.json
do
    name=${file##*/}
    base=${name%.json}
    ...
    echo "CUDA_VISIBLE_DEVICES=0 python test_reader.py \
        ...
        --n_context 20 \
        --name "$base" \
        --checkpoint_dir /data/philhoon-relevance/FiD/results/NQ_DPR_DEV_SELECTION_METHOD3
    "
