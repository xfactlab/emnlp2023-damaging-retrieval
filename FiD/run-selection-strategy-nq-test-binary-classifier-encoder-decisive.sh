...
for file in /data/philhoon-relevance/binary-classification/results/NQ-DEV-DPR/5-fold/1/fid-encoder-linear-decisive-trial6/step_80/intact_prediction/selection_methods/*.json
do
    name=${file##*/}
    base=${name%.json}
