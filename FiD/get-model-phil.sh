...
ROOT="/data/philhoon-relevance/FiD/pretrained_models"
allkeys=""
...
#wget -qO- "${MAP['nq_reader_base']}" | tar xvz -C $ROOT
#wget -qO- "${MAP['nq_reader_large']}" | tar xvz -C $ROOT
#wget -qO- "${MAP['nq_retriever']}" | tar xvz -C $ROOT
#wget -qO- "${MAP['tqa_reader_base']}" | tar xvz -C $ROOT
#wget -qO- "${MAP['tqa_reader_large']}" | tar xvz -C $ROOT
wget -qO- "${MAP['tqa_retriever']}" | tar xvz -C $ROOT
